...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 7139, function(sym, e) {
         sym.stop();
   ...
   //Edge symbol: 'estrelas'
   (function(symbolName) {   
   
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 5086, function(sym, e) {
         this.play(0);
   ...
   //Edge symbol end:'estrelas'

   //=========================================================
   
   //Edge symbol: 'luz-efeito-rua'
   (function(symbolName) {   
   ...
   //Edge symbol end:'luz-efeito-rua'
