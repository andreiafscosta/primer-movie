...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 1170, function(sym, e) {
         sym.stop();
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         //yepnope({load:"http://cdn.edgecommons.org/an/1.4.0/js/min/EdgeCommons.js",callback:function(){
         //EC.centerStage(sym);
