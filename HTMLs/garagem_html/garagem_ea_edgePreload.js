...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "garagem_ea_edge.js"},
      { load: "garagem_ea_edgeActions.js"}];
...
var plSTF="none",ctrPlS="none",minPlW="0",maxPlW=undefined,plWidth="800px",plHeight="500px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['360px', '181px','800px','500px','auto', 'auto'],
