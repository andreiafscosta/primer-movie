...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "http://eightmedia.github.com/hammer.js", user: true },
      { load: "disc_edge.js"},
      { load: "disc_edgeActions.js"}];
...
var plSTF="none",ctrPlS="none",minPlW="0",maxPlW=undefined,plWidth="400px",plHeight="200px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['180px', '45px','40px','40px','auto', 'auto'],
        fill: ["rgba(0,0,0,0)",'images/gif-load%20%281%29.gif','0px','0px']
    }]};//simpleContent
